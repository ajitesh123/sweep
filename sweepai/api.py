...
#     print("Function for run_on_ticket:", locals())
...
#     print("Function for call_on_ticket:", locals())
...
#     print("Function for hadle events:", locals())
#     action = request_dict.get("action")
...
@app.post("/on_ticket")
async def on_ticket_endpoint(request: Request):
    try:
        request_body = await request.json()
        tracking_id = request_body.get("tracking_id", get_hash())

        ticket_data = {
            "title": request_body.get("title"),
            "summary": request_body.get("summary"),
            "issue_number": request_body.get("issue_number"),
            "issue_url": request_body.get("issue_url"),
            "username": request_body.get("username"),
            "repo_full_name": request_body.get("repo_full_name"),
            "repo_description": request_body.get("repo_description"),
            "installation_id": request_body.get("installation_id"),
            "comment_id": request_body.get("comment_id"),
            "tracking_id": tracking_id,
            "edited": request_body.get("edited", False),
        }
        ...
        logger.info(
            ...
            extra={
                ...
                "repo_full_name": ticket_data["repo_full_name"],
                "name": "ticket_" + ticket_data["username"],
                "tracking_id": tracking_id,
            },
        )

        on_ticket(**ticket_data)
